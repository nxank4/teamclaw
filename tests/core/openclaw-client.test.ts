...
vi.mock("@/core/device-identity.js", () => ({
...
describe("OpenClawClient", () => {
  let OpenClawClient: typeof import("@/client/OpenClawClient.js").OpenClawClient;
  let OpenClawError: typeof import("@/client/errors.js").OpenClawError;

  beforeEach(async () => {
    lastMockWs = null;
    const mod = await import("@/client/OpenClawClient.js");
    OpenClawClient = mod.OpenClawClient;
    const errors = await import("@/client/errors.js");
  ...
  describe("stream", () => {
    ...
    it("includes usage in final chunk when reported", async () => {
      ...
      const client = new OpenClawClient({ gatewayUrl: "ws://localhost:18789" });
      const allChunks: import("@/client/types.js").StreamChunk[] = [];
