...
import { ROLE_TEMPLATES } from "../src/core/bot-definitions.js";
import { KNOWN_FLAGS } from "../src/graph/confidence/types.js";

// Mock the adapter to avoid needing OpenClaw
vi.mock("../src/adapters/worker-adapter.js", () => ({
...
describe("createCustomWorkerBots", () => {
  ...
  it("creates bots and registers role templates", async () => {
    const { createCustomWorkerBots } = await import("../src/agents/registry/node-factory.js");
