...
import type { GlobalFailureLesson } from "../src/memory/global/types.js";
...
describe("GlobalMemoryManager", () => {
  ...
  it("should define MemoryHealth type", async () => {
    const { GlobalMemoryManager } = await import("../src/memory/global/store.js");
  ...
  it("should define GlobalSuccessPattern with promotion fields", async () => {
    const { type } = await import("../src/memory/global/types.js") as Record<string, unknown>;
