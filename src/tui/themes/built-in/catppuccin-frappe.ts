...
export const catppuccinFrappe = buildTheme("catppuccin-frappe", "Catppuccin Frappé", "catppuccin", "dark", {
  ...
  userMessage: "#c6d0f5", agentResponse: "#a5adce", agentResponseBg: "#30343f", systemMessage: "#737994",
  ...
  toolRunning: "#99d1db", toolCompleted: "#a6d189", toolFailed: "#e78284", toolBorder: "#51576d", toolApprovalBg: "#352f3a",
