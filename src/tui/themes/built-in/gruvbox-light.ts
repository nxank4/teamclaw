...
export const gruvboxLight = buildTheme("gruvbox-light", "Gruvbox Light", "morhetz", "light", {
  ...
  userMessage: "#3c3836", agentResponse: "#504945", agentResponseBg: "#f0e3bf", systemMessage: "#928374",
  ...
  toolRunning: "#076678", toolCompleted: "#79740e", toolFailed: "#9d0006", toolBorder: "#d5c4a1", toolApprovalBg: "#f2e6c8",
