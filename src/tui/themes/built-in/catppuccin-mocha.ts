...
export const catppuccinMocha = buildTheme("catppuccin-mocha", "Catppuccin Mocha", "catppuccin", "dark", {
  ...
  userMessage: "#cdd6f4", agentResponse: "#bac2de", agentResponseBg: "#1f1f2b", systemMessage: "#7f849c",
  ...
  toolRunning: "#89dceb", toolCompleted: "#a6e3a1", toolFailed: "#f38ba8", toolBorder: "#45475a", toolApprovalBg: "#262230",
