...
export const tokyoNightStorm = buildTheme("tokyo-night-storm", "Tokyo Night Storm", "folke", "dark", {
  ...
  userMessage: "#c0caf5", agentResponse: "#a9b1d6", agentResponseBg: "#272c3c", systemMessage: "#565f89",
  ...
  toolRunning: "#7dcfff", toolCompleted: "#9ece6a", toolFailed: "#f7768e", toolBorder: "#3b4261", toolApprovalBg: "#2b2838",
