...
export const tokyoNight = buildTheme("tokyo-night", "Tokyo Night", "folke", "dark", {
  ...
  userMessage: "#c0caf5", agentResponse: "#a9b1d6", agentResponseBg: "#1b1f2a", systemMessage: "#565f89",
  ...
  toolRunning: "#7dcfff", toolCompleted: "#9ece6a", toolFailed: "#f7768e", toolBorder: "#292e42", toolApprovalBg: "#1f1c28",
