...
export const rosePine = buildTheme("rose-pine", "Rosé Pine", "rose-pine", "dark", {
  ...
  userMessage: "#e0def4", agentResponse: "#908caa", agentResponseBg: "#211f32", systemMessage: "#6e6a86",
  ...
  toolRunning: "#9ccfd8", toolCompleted: "#9ccfd8", toolFailed: "#eb6f92", toolBorder: "#26233a", toolApprovalBg: "#241f30",
