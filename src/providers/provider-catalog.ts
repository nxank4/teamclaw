...
export const PROVIDER_CATALOG: Record<string, ProviderMeta> = {
  ...
  deepseek: {
    ...
    models: [m("deepseek-v3-2"), m("deepseek-r1"), m("deepseek-chat")],
  ...
  together: {
    ...
    models: [
      m("meta-llama/Kimi-K2.5-Instruct"), m("deepseek-ai/DeepSeek-V3-2"), m("Qwen/Qwen3-235B-A22B"),
      m("meta-llama/Llama-4-Maverick-17B"), m("mistralai/Mistral-Large-3"), m("MiniMax/MiniMax-M2.5"),
    ],
  ...
  openrouter: {
    ...
    models: [
      ...
      m("moonshot/kimi-k2.5"), m("minimax/minimax-m2.5"),
    ],
  ...
  "opencode-zen": {
    ...
    models: [m("claude-sonnet-4-6"), m("gpt-5.4"), m("gemini-3-pro")],
